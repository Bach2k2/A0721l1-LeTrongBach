...
public class CusRepository implements ICusRepository {
    ...
    private static String Insert_Customer = "insert into khach_hang (ma_khach_hang,ma_loai_khach,ho_ten,ngay_sinh,gioi_tinh,so_cmnd,so_dien_thoai,email,dia_chi) values (?,?,?,?,?,?,?,?,?)";
